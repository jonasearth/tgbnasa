            ...
            <div class="col-sm-12">
                <form method="post" action="api.php" >
                    ...
                    <div class="row mb-3 mt-5 mx-5">
                        <div class="col-sm-12">
                            <input type="text" class="form-control input-block" name="name" placeholder="Name">
                        </div><!--col-->
                    </div><!--row-->
                    <div class="row mb-3 mx-5">
                        <div class="col-sm-12">
                            <input type="text" class="form-control input-block" name="login" placeholder="Username">
                        </div><!--col-->
                    </div><!--row-->
                    <div class="row mb-3 mx-5">
                        <div class="col-sm-12">
                            <input type="password" class="form-control input-block" name="password" placeholder="Password">
                        </div><!--col-->
                    </div><!--row-->
                    <div class="row mb-3 mx-5">
                        <div class="col-sm-12">
                            <input type="password" class="form-control input-block" name="r_password" placeholder="Confirm the Password">
                        </div><!--col-->
                    </div><!--row-->  
                    <div class="row">  
                        <div class="col-sm-3"></div>
                        <div class="col-sm-6 mb-5">
                            <button type="submit" class="btn btn-dark bg-dark btn-block btn-register">Sing-up </button>
                        </div>
                        <div class="col-sm-3"></div>
